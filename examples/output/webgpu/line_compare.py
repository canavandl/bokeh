""" Compare WebGPU, WebGL, SVG with canvas line.
...
p4 = figure(title="WebGPU", width=400, height= 400, output_backend="webgpu")
...
show(row(column(sliders), column(row(p1, p2), row(p3, p4))))
