""" Scatter plot with 1M points comparing Canvas, WebGL, and WebGPU backends.
...
p_webgl.scatter(x, y, alpha=0.1, nonselection_alpha=0.001)

p_webgpu = figure(tools=TOOLS, output_backend="webgpu", title="WebGPU")
p_webgpu.scatter(x, y, alpha=0.1, nonselection_alpha=0.001)
